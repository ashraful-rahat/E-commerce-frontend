...
export default function MenPage() {
  ...
  const fetchMenProducts = async () => {
    try {
      ...
      console.log("🔍 Men's API Response:", menProducts);
      console.log("✅ Is Array:", Array.isArray(menProducts));

      setProducts(menProducts); // ✅ always set the array
    } catch (error) {
  ...
  // Extract unique categories and sub-categories from men's products
  ...
  const getSortedProducts = () => {
    ...
    let filtered = products.filter((product) => product.gender === "men");
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="relative bg-linear-to-br from-blue-50 to-indigo-100 border-b border-blue-200 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 md:py-28 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-light">
            Discover premium fashion crafted for the modern man. From
            <span className="text-blue-600 font-medium">
              {" "}
              sophisticated formalwear{" "}
            </span>
            to
            <span className="text-blue-600 font-medium">
              {" "}
          ...
          <div className="flex flex-col lg:flex-row gap-4 justify-between items-start lg:items-center">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 text-sm">
                ...
                premium pieces curated for you
              </p>
            </div>
            ...
            <div className="flex gap-3 items-center w-full lg:w-auto justify-between lg:justify-normal">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-3 bg-white border-2 border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:border-blue-500 transition-all cursor-pointer min-w-48 justify-between"
                >
                  <span>
                    {selectedCategory === "all"
                      ? "All Categories"
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-3 bg-white border-2 border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:border-blue-500 transition-all cursor-pointer min-w-48 justify-between disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <span>
              ...
              <div className="flex gap-3 items-center">
                ...
                <div className="relative">
                  <select
                    ...
                    className="pl-4 pr-12 py-3 bg-white border-2 border-gray-300 rounded-xl text-sm font-medium text-gray-900 hover:border-blue-500 focus:ring-2 focus:ring-blue-500 transition-all cursor-pointer"
                  >
        ...
        {(!Array.isArray(products) || sortedProducts.length === 0) && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 max-w-md mx-auto mb-8 text-lg leading-relaxed">
              We&apos;re currently updating our men&lsquo;s collection. Please
